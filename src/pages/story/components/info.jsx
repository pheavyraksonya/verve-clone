...
const infoElement = [
  {
    icons: <FaRegHandshake className="w-30 h-30" />,
    txt: "Direct trade partnerships with producers",
  },
  {
    icons: <CiCoffeeBean className="w-30 h-30" />,
    txt: "Direct trade partnerships with producers",
  },
  {
    icons: <FaShop className="w-30 h-30" />,
    txt: "Direct trade partnerships with producers",
  },
];
  ...
  return (
    <section className="bg-secondary">
      <div className="max-w-5xl mx-auto pt-10 pb-10">
        <div className="flex items-center gap-10 justify-between text-primary">
      ...
      <div className="bg-secondary-foreground">
        <div className="mx-auto pt-10 pb-10 max-w-7xl">
          <div className="grid grid-cols-2 items-center justify-between gap-30">
            <div>
              <img
            ...
            <div className="space-y-5 text-primary">
              <h1 className="font-semibold text-4xl">Sustainable Practices</h1>
              <p>
