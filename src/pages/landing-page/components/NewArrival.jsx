...
import { getProducts2 } from "../../../redux/feature/new-arrival/NewArrivalSlice";
const NewArrival = () => {
      ...
      <div className="mx-auto grid w-full max-w-screen-2xl gap-12 lg:grid-cols-[40%_60%] lg:items-start">
        <div className="pt-10 lg:pt-24">
          ...
          <p className="mt-9 max-w-[18ch] text-lg leading-normal text-primary/90">
            Explore new coffees from the best producers around the world.
          </p>
          <button
            ...
            {products.map((items) => (
              <div key={items.id} className="shrink-0 w-70">
                <article className="relative min-w-0">
                  ...
                  <p className="mt-2 text-lg font-medium text-primary">20$</p>
                </article>
              </div>
            ))}
          </div>
