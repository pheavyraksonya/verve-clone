      ...
      <div className="mx-auto grid w-full max-w-screen-2xl gap-12 lg:grid-cols-[40%_60%] sm:grid-cols-1 lg:items-start">
        <div className="pt-15 lg:pt-24">
          ...
          <p className="mt-9 max-w-[18ch] text-lg leading-normal text-primary/90">
            Subscribe & Save: The Verve Way.
          </p>
          <button className="mt-10 inline-flex items-center justify-center rounded bg-primary px-8 py-4 text-sm font-bold uppercase tracking-[0.2em] text-secondary transition hover:bg-primary/90">
            Shop Subcription
          </button>
        </div>
